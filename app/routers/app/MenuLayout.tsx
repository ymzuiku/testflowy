...
export const MenuLayout: Component<JSX.HTMLAttributes<HTMLDivElement>> = (p) => {
  ...
  return (
    ...
    >
      <MenuList style={{ display: isIwPhone() ? "none" : "flex" }} />
      <UxPanel maskClose position="left" onclose={setShowMenu} show={showMenu()}>
        <MenuList style={{ width: "64vw" }} onclick={() => setShowMenu(false)} />
      </UxPanel>
      <div
        style={{
